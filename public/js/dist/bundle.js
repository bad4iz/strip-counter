...
var _buttons = __webpack_require__(331);
...
var _arrTable = __webpack_require__(333);

var _arrTable2 = _interopRequireDefault(_arrTable);
...
function initButtons() {
    ...
    _buttons2.default.add(svg.getElementById('to_zero'), initPillar);

    // Обработка кнопки ОК в модальном окне
    _buttons2.default.add(svg.getElementById("btnOkSvg"), start);
    ...
    // перезаписать шов
    _buttons2.default.add(svg.getElementById('to_zero-7-8-8'), function () {
        var value = app.getLength();
    ...
    _buttons2.default.add(svg.getElementById('to_zero-7-8-8-0'), function () {
        ...
        _buttons2.default.add(document.getElementById('endApp'), function () {
...
function start() {
    clean();
    var numberColumn = app.svg.getElementById('numberColumn');
    app.numberPillar = numberColumn.textContent;
    var num = app.svg.getElementById('Num');
...
var buttons = function () {
    var arr = [];
    return {
        add: function add(button, callback) {
            arr.push({ button: button, callback: callback });
...
var Table = function () {
    ...
    _createClass(Table, [{
        ...
        value: function update(val) {
            var rowOld = this._table.pop(row);
            var row = {
 ...
 *
 */
var ArrTable = function () {
    /**
     *
     */
    function ArrTable(tableDom) {
...
var App = function () {
    ...
    _createClass(App, [{
        ...
        value: function end(callback) {
            ...
            this.arrTable.table.forEach(function (item) {
